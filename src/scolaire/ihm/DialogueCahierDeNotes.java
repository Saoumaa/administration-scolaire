 ...
 * @author obama
 */
public class DialogueCahierDeNotes extends javax.swing.JFrame {

    /**
     * Creates new form AnneeJFrame
     */
    public DialogueCahierDeNotes() {
        initComponents();
...
//        int idAnnee = returnIdAnneeByAnneeDebut(anneeSelected.substring(0, 4));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CAHIER DE NOTES");
        ...
        jPanelChamps2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanelChamps2Layout.createSequentialGroup()
                ...
                .addGroup(jPanelChamps2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(trimestreComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanelChamps2Layout.createSequentialGroup()
                        .addGroup(jPanelChamps2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
...
//        String req2 = "SELECT ID_BULLETIN FROM BULLETIN_NOTE WHERE ID_BULLETIN = '" + idBul + "'";
    ...
    public int returnIdEleveGpByMatriculeByIdGpByAnnee(String mlle, int idGp, int idAnnee) {
        int idElevGp = 0;
        // Récupération de l'id du groupe pédagogique de l'élève sélectionné
        String reqRameneGpEleve = "select  *  from  ELEVE_GP,ELEVE "
                + "where ID_ELEVE_GP.ID_ELEVE =  ELEVE.ID_ELEVE "
                + "where ELEVE.ID_ELEVE_GP = '" + mlle + "'"
                + "And ID_GROUP_PEDAG = '" + idGp + "'"
                + "And ID_ANNEE_SCOLAIRE = '" + idAnnee + "'";
        try {
            try (Connection connexion = Maconnexion.seconnecter();
                    Statement instruction = connexion.createStatement()) {
                ResultSet lesEleveGp = instruction.executeQuery(reqRameneGpEleve);
                while (lesEleveGp.next()) {
                    idElevGp = lesEleveGp.getInt("ID_ELEVE");
                }
            }
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogueCahierDeNotes.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogueCahierDeNotes().setVisible(true);
            }
        });
    }
