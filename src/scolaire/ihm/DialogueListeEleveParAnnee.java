...
import traitement.GeneratePDFListeDesElevesParAnnee;

/**
 *
 * @author obama
 */
public class DialogueListeEleveParAnnee extends javax.swing.JFrame {

    /**
     * Creates new form AnneeJFrame
     */
    public DialogueListeEleveParAnnee() {
        initComponents();
...
//        affichetableNotes();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Liste des élèves par année");
        ...
        jPanelChamps2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanelChamps2Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(anneeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jButtonNouveau3, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
...
//        }
        String anneeSelected = anneeComboBox.getSelectedItem().toString();
        Integer idAnnee = returnIdAnneeByAnneeDebut(anneeSelected.substring(0, 4));
//        JOptionPane.showMessageDialog(this, "idAnnee = " + idAnnee);
        /*******************************************************************/
        GeneratePDFListeDesElevesParAnnee gen;
        gen = new GeneratePDFListeDesElevesParAnnee(idAnnee);
        gen.open("src\\reports\\listeEleveAnnee.pdf");
//        JOptionPane.showMessageDialog(this, "idAnnee = " + idAnnee);
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogueListeEleveParAnnee.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogueListeEleveParAnnee().setVisible(true);
            }
        });
    }
