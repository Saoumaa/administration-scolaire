 ...
 * @author obama
 */
public class GeneratePDFBilletin {
...
//    String ressource = "C:\\reports\\bulletinNotes.jrxml";
//    static String  pointDeChutte = "src/Operation/listeProduits.pdf";
//    static String pointDeChutte = "\\reports\\bulletinNotes.pdf";
//    static String pointDeChutte = "C:\\reports\\bulletinNotes.pdf";

    /* ------------------ CECI MARCHE BIEN ------------------------
    String ressource = "src/reports/bulletinNotes.jrxml";
    static String  pointDeChutte = "src/reports/bulletinNotes.pdf";
*/
    public GeneratePDFBilletin(String parametre, int valParametre, String ressource, String  pointDeChutte) //public static void main(String[] args)
    {
...
//               cx = DriverManager.getConnection("jdbc:oracle:thin:@10.6.0.211:1521:orcl", "aurelesenan", "aurelesenan");
            ...
            // - Chargement et compilation du rapportidBul
//            JasperDesign jasperDesign = JRXmlLoader.load("C:\\Documents and Settings\\Administrateur\\Bureau\\Etats\\TYPES.jrxml");
//            JasperDesign jasperDesign = JRXmlLoader.load("F:\\Donnees\\Marzouck\\GL\\Gestion Scolaire\\scolaire_swing\\swing_1\\src\\reports\\bulletinNotes.jrxml");
            JasperDesign jasperDesign = JRXmlLoader.load(ressource);
            JasperReport jasperReport = JasperCompileManager.compileReport(jasperDesign);

            // - ParamÃ¨tres Ã  envoyer au rapport
            Map parameters = new HashMap();
            parameters.put(parametre, valParametre);
//            System.out.println("Le paramètre récupéré : "+parameters.toString());
