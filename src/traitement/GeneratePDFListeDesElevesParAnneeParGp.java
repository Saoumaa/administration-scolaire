 ...
 * @author obama
 */
public class GeneratePDFListeDesElevesParAnneeParGp {
...
//    String ressource = "src/Operation/listeProduits.jrxml";
    ...
    // String ressource = "C:\\reports\\listeEleveGpAnnee.jrxml"; // ******** était là
//    static String  pointDeChutte = "src/Operation/listeProduits.pdf";
    // static String pointDeChutte = "C:\\reports\\listeEleveGpAnnee.pdf";  // ******** était là
    //static String  pointDeChutte = "src/com/reports/FAMILLES.pdf";
    
    String ressource = "src/reports/listeEleveGpAnnee.jrxml";
    String pointDeChutte = "src/reports/listeEleveGpAnnee.pdf";

    public GeneratePDFListeDesElevesParAnneeParGp(int idAnnee, int idGp) //public static void main(String[] args)
    {
