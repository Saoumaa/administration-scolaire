 ...
 * @author obama
 */
public class GeneratePDFActivites {
...
//    String ressource = "src/Operation/listeProduits.jrxml";
    String ressource = "src\\reports\\activites.jrxml";
//    static String  pointDeChutte = "src/Operation/listeProduits.pdf";
    static String  pointDeChutte = "src\\reports\\activites.pdf";
    //static String  pointDeChutte = "src/com/reports/FAMILLES.pdf";

    public GeneratePDFActivites() //public static void main(String[] args)
    {
